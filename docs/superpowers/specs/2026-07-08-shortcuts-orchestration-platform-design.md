...
> **文档状态（2026-07-21）：历史设计基线。** 本文用于追溯快捷编排平台的原始目标，不能替代 `v0.6.0` 当前实现说明。现行架构、开发流程与发布状态请参阅 [架构说明](../../ARCHITECTURE.md)、[开发指南](../../DEVELOPMENT.md) 和 [v0.6.0 发布说明](../../releases/v0.6.0.md)。
