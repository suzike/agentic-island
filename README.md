...
[![Release v0.6.2](https://img.shields.io/badge/release-v0.6.2-e89a2e)](https://github.com/suzike/agentic-island/releases/tag/v0.6.2)
...
<img src="screenshots/ask-v062.png" alt="Agentic-Island v0.6.2 · 会话增强问答工作台真实截图" width="880"/>
...
- **模型切换一致性**：问答页与设置页共享同一供应商状态机；载入配置会一次切换供应商、型号、Base URL 与 API Key，同模型不同账号不再互相覆盖或误标为使用中。
- **当前官方模型目录**：OpenAI 更新为 GPT-5.6 Sol / Terra / Luna；Claude 更新为 Sonnet 5、Opus 4.8、Fable 5 与 Haiku 4.5；DeepSeek V4 与 Kimi Code 官方 ID 保持独立目录。
- **协议级推理控制**：GPT-5.6 使用 `max_completion_tokens` 与 reasoning effort；Claude 5/4.8 按型号使用 adaptive thinking、effort 和思考摘要，Haiku 4.5 使用手动思考预算。
- **独立向量连接**：知识库和第二大脑拥有独立的 Embedding Base URL、模型与密钥。切换聊天模型不再破坏已有索引、语义检索或会话写入。
- **回答模型可追溯**：新生成的云端回答与气泡内追问显示实际请求供应商和模型，切换顶部模型后历史回答归属仍然明确。
- **多模型讨论修复**：同模型不同账号可同时参与；候选配置按完整连接身份去重，共识/辩论主持使用本轮已验证配置。
...
<table>
<tr>
<td width="50%" align="center"><img src="screenshots/ask-v062.png" alt="问答工作台"/><br/><b>问答</b><br/><sub>模型切换 · 会话分支 · 气泡追问 · 独立 RAG</sub></td>
<td width="50%" align="center"><img src="screenshots/shortcuts-v062.png" alt="快捷工程工作流"/><br/><b>快捷</b><br/><sub>项目上下文 · 12 条工程工作流</sub></td>
</tr>
<tr>
<td width="50%" align="center"><img src="screenshots/todos-v062.png" alt="智能待办工作台"/><br/><b>待办</b><br/><sub>计划 · 看板 · 任务属性 · AI 执行辅助</sub></td>
<td width="50%" align="center"><img src="screenshots/notes-v062.png" alt="灵感便签知识工作台"/><br/><b>灵感便签</b><br/><sub>Markdown · 双链 · 模板 · 知识工具</sub></td>
</tr>
<tr>
<td width="50%" align="center"><img src="screenshots/news-v062.png" alt="资讯情报工作台"/><br/><b>资讯</b><br/><sub>观察清单 · 信号处置 · 情报雷达</sub></td>
<td width="50%" align="center"><img src="screenshots/review-v062.png" alt="每日复盘与工作洞察"/><br/><b>复盘</b><br/><sub>活动流水 · 日报周报 · 效率洞察</sub></td>
</tr>
<tr>
<td width="50%" align="center"><img src="screenshots/recording-v062.png" alt="专业录屏工坊"/><br/><b>录屏</b><br/><sub>多源采集 · 实时运镜 · 三轨剪辑 · AI 后期</sub></td>
<td width="50%" align="center"><img src="screenshots/settings-v062.png" alt="设置与主题系统"/><br/><b>设置</b><br/><sub>供应商隔离 · 连接诊断 · 多显示器 · 主题</sub></td>
</tr>
</table>
...
| **问答** | OpenAI 兼容云模型、Anthropic Messages API 与本机 Claude Code/Codex；供应商/账号原子切换与回答模型标记；快速/深度协议映射；会话分支树与任意节点 Fork；分支切换、命名和合并；长期记忆与持续会话指令；上下文钉选/排除和附件连续上下文；多模型并行、共识与辩论；附着原回答的 AI 分析；每条回答气泡内的连续追问支线；引用追问；对话写入知识库；动态灵感推荐 |
...
```text
Agentic-Island-Setup-0.6.2.exe
```
